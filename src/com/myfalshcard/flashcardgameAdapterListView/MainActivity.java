...
import com.myfalshcard.flashcardgameAdapterListView.R;
...
//    };
    ...
    private CustomerApater<String> adapter;
    private static String operator = "Add";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
    	String[] lists = {"Add", "Subtract", "Multiply", "Divide", "Mode"};
      ...
      st = savedInstanceState.getString("result");
       ...
       adapter = new CustomerApater<String>(MainActivity.this,android.R.layout.simple_list_item_1,lists);
       ListView adapterListView = (ListView) findViewById(R.id.listView1);
